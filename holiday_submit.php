...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Validate the data if needed (e.g., check if the date is valid, etc.)
    ...
    // Prepare and execute the SQL query to insert data into the "holidays" table
    $sql = "INSERT INTO holidays (holiday_date, holiday_name) VALUES (?, ?)";
