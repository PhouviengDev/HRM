    ...
    if (isset($_GET["id"])) {
        ...
        if ($_SERVER["REQUEST_METHOD"] === "POST") {
            ...
            if ($conn->query($sql) === TRUE) {
                ...
                echo "Error updating leave type: " . $conn->error;
            }
        }

        // Fetch the leave type from the database
        $sql = "SELECT * FROM leave_types WHERE id='$leaveTypeId'";
        ...
        <div class="mb-3">
            ...
            <input type="text" name="lt_name" id="lt_name" class="form-control" value="<?php echo $lt_name; ?>" required>
        </div>
