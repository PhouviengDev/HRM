  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      <section class="content">
        ...
        <div class="container">
        <h1 class="mt-4 mb-4">Edit Holiday</h1>
        <?php
        if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET["id"])) {
            ...
            // Retrieve holiday data based on the given ID
            $sql = "SELECT id, holiday_date, holiday_name FROM holidays WHERE id = ?";
            ...
            if ($result->num_rows == 1) {
                ...
                echo "<form action='update_holiday.php' method='post'>";
                echo "<input type='hidden' name='holiday_id' value='" . $holiday_id . "'>";
                echo "<div class='mb-3'>";
                echo "<label for='holiday_date' class='form-label'>Holiday Date:</label>";
                echo "<input type='date' id='holiday_date' name='holiday_date' value='" . $holiday_date . "' class='form-control' required>";
                echo "</div>";

                echo "<div class='mb-3'>";
                echo "<label for='holiday_name' class='form-label'>Holiday Name:</label>";
                echo "<input type='text' id='holiday_name' name='holiday_name' value='" . $holiday_name . "' class='form-control' required>";
                echo "</div>";
